<div class="w-full bg-white px-12 h-20">
    <div class="flex justify-between items-center h-full">
        ...
        <div class="flex items-center border border-gray-300 rounded-full px-4 py-2 space-x-2 w-1/2">
            <span class="text-secondary">🇲🇾</span>
            <span class="text-tertiary">Selangor</span>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-tertiary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-4.35-4.35M3 10a7 7 0 1114 0 7 7 0 01-14 0z" />
            </svg>
            <input type="text" placeholder="Job title, keyword, company" class="w-full outline-none text-gray-700" />
        </div>
