...
<x-dynamic-component :component="$layout">
    <div class="container mx-auto p-6">
        ...
        @else
            ...
            <div class="space-y-4">
                @foreach ($jobs as $job)
                    <div onclick="window.location='{{ route('jobListings.details', $job->id) }}'"
                        ...
                        <div class="flex-1">
                            ...
                            <!-- Safely check if user and company exist -->
                            <p class="text-sm text-gray-600 font-semibold">
                                {{ $job->user && $job->user->company ? $job->user->company->name : 'No company' }}
                            </p>
