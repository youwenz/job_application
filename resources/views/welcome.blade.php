...
<div class="w-full bg-white flex justify-center items-center flex-row mt-16 py-12">
    <!-- Candidate Card -->
    <div
        class="w-[40%] h-65 rounded-lg bg-primary bg-cover bg-center flex flex-col mx-8 bg-[url('/public/images/office-background.jpg')]">
        <!-- Overlay for better text visibility -->
        <div class="w-full h-full bg-black opacity-50">
            <div class="w-full h-full rounded-2xl flex flex-col justify-center space-y-4 p-4 pl-[10%]">
                <p class="text-3xl text-white font-bold">Become a Candidate</p>
                <p class="text-lg text-gray-200">Find your dream job and get hired</p>

                <!-- Register Button -->
                <a href="/register"
                   class="bg-white text-secondary self-start text-sm font-bold py-2 px-6 rounded-sm transition hover:bg-blue-700 flex flex-row">
                    Register Now
                    <x-heroicon-s-arrow-long-right class="w-6 h-6 text-secondary ml-4"/>
    ...
    <!-- Candidate Card -->
    <div
        class="w-[40%] h-65 rounded-lg bg-primary bg-fit bg-center flex flex-col mx-8 bg-[url('/public/images/employer-bg.jpg')] ">
        <!-- Overlay for better text visibility -->
        <div class="w-full h-full bg-black opacity-50">
            <div class="w-full h-full rounded-2xl flex flex-col justify-center space-y-4 p-4 pl-[10%]">
                <p class="text-3xl text-white font-bold">Become an Employer</p>
                <p class="text-lg text-gray-200">Find your best candidates here</p>
